...
Public Class CMySqlClient : Inherits CDataSrcLocal
    ...
    Shared Sub CMySqlClient()
        m_factoryLoc.Add("mysql", New DFactoryLoc(Function(cs As String) New CMySqlClient(cs)))

        CAdoData.Register(GetType(MySql.Data.MySqlClient.MySqlDataReader), New CAdoData.DGetDateByIndex(Function(dr As IDataReader, col As Integer, nullVal As Date) GetDate(dr(col), nullVal)))
        CAdoData.Register(GetType(MySql.Data.MySqlClient.MySqlDataReader), New CAdoData.DGetDateByName(Function(dr As IDataReader, col As String, nullVal As Date) GetDate(dr(col), nullVal)))
    End Sub
...
#Region "Platform-Specific"
    Public Overrides ReadOnly Property IsMySql As Boolean
        Get
            Return True
        End Get
    End Property
