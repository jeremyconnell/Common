Public Class UCOleDb
    ...
    Public Sub Display()
        ...
        With CUser_Connections.Storage
            For Each i As COleDbConnection In .OleDb_ByDate
                lvRecent.Items.Add(i.ConnectionString).Tag = i

                If .LastConnectionType = EDriverTab.OleDb Then
                    If .LastConnectionIndex = .OleDbConnections.IndexOf(i) Then
    ...
    Private Sub lvRecent_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles lvRecent.SelectedIndexChanged
        ...
        With CUser_Connections.Storage.OleDb_ByDate(lvRecent.SelectedIndices(0))
