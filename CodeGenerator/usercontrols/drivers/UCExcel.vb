Public Class UCExcel
    ...
    Private ReadOnly Property Data() As CMSExcelConnectionList
        Get
            If rbName.Checked Then
                Return CUser_Connections.Storage.MsExcel_ByName
            Else
                Return CUser_Connections.Storage.MsExcel_ByDate
            End If
        End Get
    End Property
    Public Sub Display()
        ...
        With CUser_Connections.Storage
            For Each i As CMSExcelConnection In Data
                ...
                If .LastConnectionType = EDriverTab.Excel Then
                    If .LastConnectionIndex = .MSExcelConnections.IndexOf(i) Then
                        txtPath.Text = i.Path
    ...
    Private Sub btnTest_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnTest.Click
        If txtPath.Text.Length = 0 Then
            MessageBox.Show("Browse to an Excel spreadsheet", "No spreadsheet selected", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Exit Sub
        End If
        If Not IO.File.Exists(txtPath.Text) Then
            ...
            Exit Sub
        End If
        RaiseEvent TestClicked(CDataSrc.OleDbFromExcelPath(txtPath.Text))
    End Sub
    ...
    Private Sub miDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles miDelete.Click
        ...
        With lvRecent.SelectedItems(0)
            Dim con As CMSExcelConnection = CType(.Tag, CMSExcelConnection)
            CUser_Connections.Storage.MSExcelConnections.Remove(con)
