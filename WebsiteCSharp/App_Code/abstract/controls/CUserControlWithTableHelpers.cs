...
public class CUserControlWithTableHelpers :  UserControl
{
    ...
    private HyperLink CellLink(TableCell td, string s, string url, bool black = true, bool bold = true, string ttip = null, string confirmMsg = null)
    {
