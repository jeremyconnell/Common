...
#Region "Page Events"
	Protected Overrides Sub PageInit()
		...
		End If
        AddMenuSide("Sql", CSitemap.SelfSql, True)


        chkRemote.Checked = CSession.SqlUseProd

        'Dropdowns, last-cmd
        Dim sql As New CAudit_Sql

        ddHistory.DataValueField = "SqlId"
        ddHistory.DataTextField = "SqlText"
        ddHistory.DataSource = sql.RecentUnique()
		ddHistory.DataBind()
