<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Sql.aspx.vb" Inherits="pages_sql_Sql" 
	...
	<table width="100%" height="100%">
	    <tr>
	        <td nowrap>
				...
				<asp:Button ID="btnExecute" Runat="server" Text="Execute"  style="float:right" Width=160 />
			</td>
		</tr>
	</table>
</asp:Content>
...
<asp:Content ID=b runat=server ContentPlaceHolderID=below>
        <fieldset>
		    ...
		    <asp:TextBox ID="txtSql" Runat="server" Width="900" TextMode="MultiLine" Rows="4" Font-Size=12px />
