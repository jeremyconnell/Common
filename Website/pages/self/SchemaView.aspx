<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SchemaView.aspx.cs" Inherits="pages_self_SchemaView"
...
<asp:Content ID="c" ContentPlaceHolderID="body" runat="server">
    <asp:RadioButtonList ID="rbl" runat="server" AutoPostBack="true" RepeatDirection="Horizontal">
        <asp:ListItem Value="-100">Local</asp:ListItem>
        <asp:ListItem Value="-200">Prod</asp:ListItem>
    </asp:RadioButtonList>
