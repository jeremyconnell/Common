...
#Region "Interface #1 of 2 - For cached data"
    ...
    Public Function Display(ByVal list As IList) As IList
        ...
        'Perform the paging
        Return CUtilities.Page_(list, PageSize, CurrentPage - 1)
    End Function
...
#Region "Optional Properties"
    ...
    Public Property PageSize() As Integer
        Get
            Return CWeb.RequestInt(QueryString_PageSize, m_pageSize)
        End Get
...
#Region "Private"
    ...
    Private Sub DisplayButtons()
        litSummary.Text = String.Format(litSummary.Text, (CurrentPage - 1) * PageSize + 1, Math.Min(CurrentPage * PageSize, TotalRecords), TotalRecords.ToString("n0"))
