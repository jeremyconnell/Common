...
Partial Class usercontrols_UCMenu : Inherits UserControl
    ...
    Public Shared RIGHT_ALIGN As New List(Of String)(New String() {}) '"SQL",  "Error Log", "Audit Trail", "Audit", "Errors", "Sessions", "Roles", "Users"})
	Public Shared PAD_LEFT As New List(Of String)(New String() {"Groups", "Apps", "Sessions", "Releases", "Audit", "SQL"})
