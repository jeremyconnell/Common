...
Partial Class usercontrols_extensions_UCListbox : Inherits CCustomControl
...
#Region "Members"
    Private m_noSelectionText As String = "-- No Selection Made --"
#End Region
...
#Region "Helpers - Binding"
    ...
    Public Property BlankItemText() As String
        Set(ByVal value As String)
            ListBox.Items(0).Text = value
        End Set
        Get
            If ListBox.Items.Count = 0 Then Return String.Empty
            Return ListBox.Items(0).Text
        End Get
    End Property
#End Region
    ...
    Protected Sub Page_PreRender(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreRender
        ...
        If Page.IsPostBack Then
            If CtrlMain.UniqueID = Request.Form("__EVENTTARGET") Then
                If ListBox.SelectedIndex < 1 Then RaiseEvent SelectedIndexChanged()
            End If
        End If
