<%@ Control Language="VB" AutoEventWireup="false" CodeFile="UCListbox.ascx.vb" Inherits="usercontrols_extensions_UCListbox" %>
...
<uc:UCSeparator1 ID="_s1" runat="server" />
  <asp:ListBox ID="ctrl" runat="server" EnableViewState="false" />
