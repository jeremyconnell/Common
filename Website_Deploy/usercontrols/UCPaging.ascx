...
<asp:panel ID="divPagination" class="pagination" runat="server">
  ...
  <div class="page_buttons">
    <asp:HyperLink id="lnkPrev" runat="server" CssClass="nav">&laquo; Previous Page</asp:HyperLink>
    
    <asp:Label ID="lbl" runat="server" />
    
    <asp:HyperLink id="lnkNext" runat="server" CssClass="nav">Next Page &raquo;</asp:HyperLink>
