...
Partial Class MasterPage : Inherits CMasterPage
    ...
    Protected Sub Page_PreRender(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreRender
		...
		ctrlMenu.AddRight("Deployments", CSitemap.Clients(), False, "Deployments")
		ctrlMenu.AddRight("System", CSitemap.Users(), True, "System")
    ...
    Protected Overrides ReadOnly Property SideLinks As PlaceHolder
        Get
            Return plhSideLinks
        End Get
    End Property
