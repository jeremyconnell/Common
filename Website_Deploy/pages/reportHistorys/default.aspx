<%@ Page EnableEventValidation="false" EnableViewState="false" Language="C#" AutoEventWireup="true" CodeFile="default.aspx.cs" Inherits="pages_ReportHistorys_default" 
  MasterPageFile="~/masterpages/deploy.master"
  Title="Reports"
%>

<%@ Register src="usercontrols/UCReportHistorys.ascx" tagname="UCReportHistorys" tagprefix="uc" %>
...
<asp:Content ID="c" ContentPlaceHolderID="body" runat="server">
   ...
   <!-- Search Results -->
    <uc:UCReportHistorys ID="ctrlReportHistorys" runat="server" OnExportClick="ctrl_ExportClick" OnResortClick="ctrl_ResortClick" />
</asp:Content>
