...
public partial class pages_binaryFiles_usercontrols_UCTable : System.Web.UI.UserControl
{
    ...
    private static pages_binaryFiles_usercontrols_UCColumn UCColumn(Control target)
    {
        Control ctrl = target.Page.LoadControl(CSitemap.UCColumn());
        target.Controls.Add(ctrl);
        return (pages_binaryFiles_usercontrols_UCColumn)ctrl;
    }
    ...
    private static pages_binaryFiles_usercontrols_UCIndex UCIndex(Control target)
    {
        Control ctrl = target.Page.LoadControl(CSitemap.UCIndex());
        target.Controls.Add(ctrl);
        return (pages_binaryFiles_usercontrols_UCIndex)ctrl;
    }
    #endregion
}