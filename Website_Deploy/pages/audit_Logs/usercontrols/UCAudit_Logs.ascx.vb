...
#Region "Interface"
	Public Sub Display(ByVal audit_Logs As CAudit_LogList, Optional instanceId As Integer? = Nothing) 'Single page due to sql-based paging (by exposing Me.Info)
		...
		For Each i As CAudit_Log In audit_Logs
			UCAudit_Log(plh).Display(i, audit_Logs, Me.PagingInfo, instanceId)
		Next
	End Sub
