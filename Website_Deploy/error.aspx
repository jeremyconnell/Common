<%@ Page Title="Error Page" Language="C#" MasterPageFile="~/masterpages/deploy.master" AutoEventWireup="true" CodeFile="error.aspx.cs" Inherits="pages_globalError_ContactAdmin" %>
...
<asp:Content ID="b" ContentPlaceHolderID="body" Runat="Server"> 
    ...
    <br />
    For urgent enquiries contact the administrator: <asp:HyperLink id="lnk" Runat="Server" NavigateUrl="mailto:jeremy.connell@controltrack.com.au?subject=Error Page">ControlTrack</asp:HyperLink><br />
    <br />
    <br />
