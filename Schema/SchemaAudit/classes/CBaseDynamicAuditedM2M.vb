...
Public MustInherit Class CBaseDynamicAuditedM2M : Inherits Framework.CBaseDynamicM2M
...
#Region "Abstract/Virtual"
    ...
    Protected MustOverride Function OriginalState(ByVal txOrNull As IDbTransaction) As CBaseDynamicAuditedM2M
#End Region
...
#Region "Audit Trail Logic"
    ...
    Public Overloads Overrides Sub Save(ByVal txOrNull As System.Data.IDbTransaction)
        ...
        With New CAudit_Trail(DataSrc) 'Audit trail goes in same database by default
            ...
            after = Me.ToXml
            .AuditDataPrimaryKey = String.Concat(Me.PrimaryKeyValue, "/", Me.SecondaryKeyValue)
