...
Partial Public Class CMySqlConnection : Inherits CElement

#Region "Constants"
    Public Const TAG_NAME As String = "MySqlConnection"
...
#Region "Public - Node Level"
    Public Overrides Sub Import(parent As XmlNode)
        ...
        m_port = CXml.AttributeInt(node, "Port", m_port)
    ...
    Public Overrides Sub Export(parent As XmlNode)    
        ...
        CXml.AttributeSet(node, "Port", m_port)
        'ChildNodes - Single
