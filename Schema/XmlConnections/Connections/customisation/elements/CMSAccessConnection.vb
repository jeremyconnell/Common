Partial Public Class CMSAccessConnection : Implements IComparable(Of CMSAccessConnection)
...
#Region "Equals"
    ...
    End Function
    Public Function CompareTo(ByVal other As CMSAccessConnection) As Integer Implements System.IComparable(Of CMSAccessConnection).CompareTo
    ...
    Public Overrides Function Equals(ByVal obj As Object) As Boolean
        If Not TypeOf (obj) Is CMSAccessConnection Then Return False
        With CType(obj, CMSAccessConnection)
